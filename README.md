...
scripts/test-thin dist/hpc-workspace-thin-0.6.1-preview1-linux-amd64.sif
scripts/package-thin 0.6.1-preview1
scripts/test-thin-install dist/release-0.6.1-preview1.json
```
